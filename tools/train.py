...
def parse_config():
    ...
    parser.add_argument('--batch_size_val', type=int, default=None, required=False, help='batch size for validation')
...
def main():
    ...
    val_batch_size = args.batch_size_val if args.batch_size_val is not None else args.batch_size

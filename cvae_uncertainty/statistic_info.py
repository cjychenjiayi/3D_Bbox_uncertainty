...
with open(KITTI_ROOT / 'kitti_dbinfos_val.pkl', 'rb') as f:
...
epoch='1600'
for file in [
    OUTPUT_ROOT / exp / tag / 'eval' / f'epoch_{epoch}' / 'val' / 'default' / 'final_result' / 'data' / 'result_val1.pkl',
    OUTPUT_ROOT / exp / tag / 'eval' / f'epoch_{epoch}' / 'val' / 'default' / 'final_result' / 'data' / 'result_val2.pkl',
    OUTPUT_ROOT / exp / tag / 'eval' / f'epoch_{epoch}' / 'val' / 'default' / 'final_result' / 'data' / 'result_val3.pkl',
    OUTPUT_ROOT / exp / tag / 'eval' / f'epoch_{epoch}' / 'val' / 'default' / 'final_result' / 'data' / 'result_val4.pkl',
    OUTPUT_ROOT / exp / tag / 'eval' / f'epoch_{epoch}' / 'val' / 'default' / 'final_result' / 'data' / 'result_val5.pkl'
]:

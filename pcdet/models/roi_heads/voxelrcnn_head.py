...
class VoxelRCNNHead(RoIHeadTemplate):
    ...
    def roi_grid_pool(self, batch_dict):
        ...
        roi_grid_coords_x = torch.div(roi_grid_xyz[:, :, 0:1] - self.point_cloud_range[0], self.voxel_size[0], rounding_mode='trunc')
        roi_grid_coords_y = torch.div(roi_grid_xyz[:, :, 1:2] - self.point_cloud_range[1], self.voxel_size[1], rounding_mode='trunc')
        roi_grid_coords_z = torch.div(roi_grid_xyz[:, :, 2:3] - self.point_cloud_range[2], self.voxel_size[2], rounding_mode='trunc')
